...
class _MainScreenState extends State<MainScreen> with WidgetsBindingObserver {
  ...
  Widget _buildHeader() {
    return BlocBuilder<FolderBloc, FolderState>(
      builder: (context, folderState) {
        final isEditMode = folderState is FolderLoaded
            ? folderState.isEditMode
            : false;
        final hasSelectedFolders = folderState is FolderLoaded
            ? folderState.hasSelectedFolders
            : false;
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        IconData(
                          _selectedFolder!.iconCodePoint,
                          fontFamily: 'MaterialIcons',
                        ),
                        color: Color(_selectedFolder!.colorValue),
                        size: 16,
                      ),
  ...
  Widget _buildEditableFolderItem(
    FolderEntity folder,
    bool isSelected,
    FolderLoaded state,
  ) {
